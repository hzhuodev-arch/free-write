...
const MODES: Mode[] = ['format', 'restructure']
  ...
  return (
    <div className="flex h-11 shrink-0 items-center gap-3 border-b border-zinc-200 bg-white px-5 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div
        ...
        className="flex items-center gap-0.5 rounded-[7px] border border-zinc-200 bg-zinc-100 p-0.5 dark:border-zinc-800 dark:bg-zinc-900"
      >
        {MODES.map((m) => (
          <button
            key={m}
      ...
      <span className="text-[11px] text-zinc-400">
        Press{' '}
        <kbd className="rounded border border-zinc-200 bg-zinc-100 px-1 py-0.5 font-mono text-[10px] text-zinc-500 shadow-[0_1px_0_theme(colors.zinc.200)] dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:shadow-zinc-700">
          ⌘S
        </kbd>{' '}
        to transform
      </span>
